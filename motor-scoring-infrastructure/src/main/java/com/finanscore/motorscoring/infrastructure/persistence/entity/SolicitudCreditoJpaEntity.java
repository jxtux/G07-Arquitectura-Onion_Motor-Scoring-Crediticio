...
@Entity @Table(name="solicitudes_credito",uniqueConstraints=@UniqueConstraint(name="uk_solicitud_identificador_externo",columnNames="identificador_externo"))public class SolicitudCreditoJpaEntity{
    @Id @GeneratedValue(strategy=GenerationType.IDENTITY)@Column(name="id_solicitud")private Long id;
    @Column(name="id_solicitante",nullable=false)private Long idSolicitante;
    ...
    @Column(name="plazo_solicitado",nullable=false)private int plazoSolicitado;
    @Enumerated(EnumType.STRING)@Column(nullable=false,length=10)private Moneda moneda;
    @Column(name="finalidad_credito",nullable=false,length=150)private String finalidadCredito;
    @Column(name="canal_origen",nullable=false,length=50)private String canalOrigen;
    @Column(name="fecha_registro",nullable=false)private LocalDateTime fechaRegistro;
    @Column(name="identificador_externo",nullable=false,length=100)private String identificadorExterno;
